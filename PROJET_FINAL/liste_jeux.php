...
<div class="header">
  ...
  <h1 id="titre"><span>Découvrez nos jeux !<span></h1>
  <hr>
  <div class="bloc-text">
    <p>Découvrez les classiques</br></br>
     Tous les jeux sont programmés avec Javascript.<br/><br/><img src=https://th.bing.com/th/id/OIP.I5XOh9o_kbTNsXnsIc53aAHaHa?w=177&h=180&c=7&r=0&o=5&pid=1.7><br/><br/>
      Le nombre de jeux est en constante évolution. <br/><div class="blink"> Amusez-vous bien !</div></p>
      </div>
      <hr>
  <main>
    <div class="container">
